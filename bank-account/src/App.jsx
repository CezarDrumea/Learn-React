...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case 'requestLoan':
      return { ...state, balance: state.balance + LOAN, loan: LOAN };

    case 'payLoan':
      if (state.balance >= state.loan)
        return { ...state, balance: state.balance - state.loan, loan: 0 };
      else return { ...state, balance: 0, loan: state.loan - state.balance };
    ...
    <div className='App'>
      ...
      <p>
        <button
          ...
          disabled={state.loan !== 0 || !state.isActive}
        >
      ...
      <p>
        <button
          ...
          disabled={state.balance !== 0 || state.loan !== 0 || !state.isActive}
        >
          Close account
        </button>
      </p>
